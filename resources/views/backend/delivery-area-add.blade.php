	          	...
	          	<div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Delivery Area Add</h3>
                        </div>
                        <form action="{{ route('delivery_post') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputTestimonialImage">Map Description</label>
                                    <textarea id="summernote" name="delivery_desc"></textarea>
                                </div>
