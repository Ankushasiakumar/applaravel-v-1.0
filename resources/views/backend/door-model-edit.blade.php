	          	...
	          	<div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Door Model Settings</h3>
                        </div>
                        <form action="{{ route('door_model_edit_post') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="card-body">
                                ...
                                <input type="hidden" name="door_model_id" value="{{ $edit_record->id }}">
