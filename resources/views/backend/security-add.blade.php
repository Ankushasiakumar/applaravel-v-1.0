	          	...
	          	<div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Security Add</h3>
                        </div>
                        <form action="{{ route('security_post') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputTestimonialImage">Security Name</label>
                                    <input type="text" name="security_name" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="cladding_images" id="exampleInputBannerBackground">
