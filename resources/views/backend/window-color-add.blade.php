	          	...
	          	<div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Window Color Add</h3>
                        </div>
                        <form action="{{ route('window_color_post') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="color_val" class="form-control my-colorpicker1">
                                </div>
