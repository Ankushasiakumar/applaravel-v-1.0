	          	...
	          	<div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Window Model Settings</h3>
                        </div>
                        <form action="{{ route('window_model_edit_post') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputTestimonialImage">Model Name</label>
                                    <input type="text" name="model_name" value="{{ $edit_record->model_name }}" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                    	<div class="col-md-2">
                                    		<img src="{{ $edit_record->model_image }}" class="img-thumbnail img-lg">
                                    	</div>
                                    	<div class="col-md-10">
                                ...
                                <input type="hidden" name="window_model_id" value="{{ $edit_record->id }}">

                                <div class="form-group">
                                    <label for="exampleInputTestimonialImage">Model Description</label>
                                    <textarea class="form-control" name="model_desc">{{ $edit_record->model_desc }}</textarea>
                                </div>
