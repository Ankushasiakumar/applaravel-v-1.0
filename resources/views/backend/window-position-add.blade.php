	          	...
	          	<div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Window Position Add</h3>
                        </div>
                        <form action="{{ route('window_position_post') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="position_desc"></textarea>
                                </div>
