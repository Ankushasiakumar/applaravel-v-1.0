	          	...
	          	<div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Window Position Settings</h3>
                        </div>
                        <form action="{{ route('window_position_edit_post') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="card-body">
                                ...
                                <input type="hidden" name="window_position_id" value="{{ $edit_record->id }}">
